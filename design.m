...
% series1.real_pole = 0;   % 极点  a
% series1.real_zero = 0;   % 零点  a
% series1.complex_pole = 1;    % 复极点  a+bj
% series1.complex_zero = 1;    % 复领点  a+bj
% series1.lead = 0;            % 环节    a,b
...
% series.real_pole = 0;   % 极点  a
% series.real_zero = 0;   % 零点  a
% series.complex_pole = 0;    % 复极点  a+bj
% series.complex_zero = 0;    % 复领点  a+bj
